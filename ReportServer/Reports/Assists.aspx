<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Assists.aspx.cs" Inherits="ReportServer.Reports.Assists" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FSP Assists Report</title>
...
<body>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <div class="control-group">
            <asp:Label ID="lblSelectContractors" Text="Select Contract Company" class="control-label" runat="server"></asp:Label>
            <div class="controls">
        ...
        <div class="control-group">
            <asp:Label ID="Label3" runat="server" Text="Select Incident Type" class="control-label"></asp:Label>
            <div class="controls">
                <asp:DropDownList ID="ddlAssistTypes" runat="server">
                </asp:DropDownList>
            </div>
        </div>
        <div class="control-group">
            <asp:Label ID="lblBeats" runat="server" Text="Select Beat Number" class="control-label"></asp:Label>
            <div class="controls">
                <asp:DropDownList ID="ddlBeats" runat="server"></asp:DropDownList>
            </div>
        </div>
        <div class="control-group">
            <asp:Label ID="lblSortBy" runat="server" Text="Sort data by" class="control-label"></asp:Label>
            <div class="controls">
                <asp:DropDownList ID="ddlSortBy" runat="server">
                    <asp:ListItem>Contractors</asp:ListItem>
                    <asp:ListItem>Incident Types</asp:ListItem>
                    <asp:ListItem>Assist Types</asp:ListItem>
                </asp:DropDownList>
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
                ...
                <asp:Button ID="btnExportExcel" runat="server" OnClick="btnExportExcel_Click"
                    Text="Export Excel (Wait for data to load)" CssClass="btn btn-primary" />
            </div>
        </div>
