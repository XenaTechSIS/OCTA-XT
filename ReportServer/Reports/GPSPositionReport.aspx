...
<body>
    ...
    <legend>GPS Position Report</legend>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <asp:Button ID="btnGetVehicles" runat="server" Text="Get Vehicles"
                    OnClick="btnGetVehicles_Click" CssClass="btn btn-warning" />
            </div>
        </div>
        <div class="control-group">
            <asp:Label ID="Label3" runat="server" Text="Select Vehicles" class="control-label"></asp:Label>
            <div class="controls">
                <asp:DropDownList ID="ddlVehicles" runat="server"></asp:DropDownList>
            </div>
        </div>
        <div class="control-group">
            <div class="controls">
