<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TruckMessages.aspx.cs" Inherits="ReportServer.Reports.TruckMessages" %>
...
<body>
    ...
    <div><img src="../img/octa_survey%20layout_header.png" /></div>
     <header>Truck Messages Report</header>
    <div>
    ...
    <div>
        <asp:Label ID="lblSelectTrucks" Text="Select Trucks" runat="server"></asp:Label>
