...
<body>
    ...
    <legend>Driver Break and Lunch Report</legend>
    ...
    <form id="form1" runat="server" class="form-horizontal">
        ...
        <div class="control-group">
            <asp:Label ID="lblSelectContractors" Text="Select Contract Company" runat="server" class="control-label"></asp:Label>
            <div class="controls">
                ...
                <asp:Button ID="btnGetDrivers" runat="server" Text="Load Drivers"
                    OnClick="btnGetDrivers_Click" CssClass="btn btn-warning" />
            </div>
        </div>
        <div class="control-group">
            <asp:Label ID="Label3" runat="server" Text="Select Drivers" class="control-label"></asp:Label>
            <div class="controls">
