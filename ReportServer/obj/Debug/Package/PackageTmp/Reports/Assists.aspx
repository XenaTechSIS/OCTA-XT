...
<header>Assists Report</header>
    ...
    <div>
        <asp:Label ID="Label3" runat="server" Text="Select Incident Type "></asp:Label>
        <asp:DropDownList ID="ddlAssistTypes" runat="server">
        </asp:DropDownList>
    </div>
    <div>
        <asp:Label ID="lblBeats" runat="server" Text="Select Beat Number"></asp:Label>
        <asp:DropDownList ID="ddlBeats" runat="server"></asp:DropDownList>
    </div>
    <div>
        <asp:Label ID="lblSortBy" runat="server" Text="Sort data by "></asp:Label>
