<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Schedules.aspx.cs" Inherits="ReportServer.Reports.Schedules" %>
...
<body>
    ...
    <header>Schedules Report</header>
    <div>
        ...
        <br />
        <asp:CheckBox ID="chkFilterExpired" runat="server" TextAlign="Left" Text="Filter Expired"/>
    </div>
