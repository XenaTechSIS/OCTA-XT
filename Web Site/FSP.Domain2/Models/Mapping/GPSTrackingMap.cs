...
{
    public class GPSTrackingMap : EntityTypeConfiguration<GPSTracking>
    {
        public GPSTrackingMap()
        {
            // Primary Key
            this.HasKey(t => t.GPSID);
            ...
            this.Property(t => t.AssignedBeat).HasColumnName("AssignedBeat");
        }
    }
}
