...
{
    public class vDropZoneMap : EntityTypeConfiguration<vDropZone>
    {
        public vDropZoneMap()
        {
            // Primary Key
            this.HasKey(t => new { t.DropZoneID, t.Location, t.Comments, t.Restrictions, t.DropZoneNumber, t.DropZoneDescription, t.City, t.PDPhoneNumber, t.Capacity });
