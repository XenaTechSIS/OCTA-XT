$(document).ready(function () {
    ...
    $('#btnStatus').click(function () {
        ...
        window.location = $("#websitePath").attr("data-websitePath") + '/Admin';
    ...
    function getDrivers() {
        ...
        $.get(url,
               function (drivers) {
                   console.group('drivers');
                   console.log('%d drivers returned', drivers.length);
    ...
    function getContractors() {
        ...
        $.get(url,
               function (contractors) {
                   console.group('contractors');
                   console.log('%d contractors returned', contractors.length);
                   var selItem = '';
    ...
    function getVehicles() {
        ...
        $.get(url,
                function (vehicles) {
                    ...
                    console.log('%d vehicles returned', vehicles.length);
                    var selItem = '';
    ...
    function getBeatNumbers() {
        ...
        $.get(url,
                function (beatNumbers) {
                    console.group('beatnumbers');
                    console.log('%d beat numbers returned', beatNumbers.length);
                    var selItem = '';
    ...
    function PostAssistData() {
        ...
        if($('#assistStart').val()){
            Onsitedt = dateToWcf($('#assistStart').val());
        }
        else{
        ...
        if ($('#assistEnd').val()) {
            x1098dt = dateToWcf($('#assistEnd').val());
        }
        else {
        ...
        if ($('#txtDispatchTime').val()) {
            x1097dt = dateToWcf($('#txtDispatchTime').val());
        }
        else {
        ...
        //var _location = $('#ddlDirection').val() + ' ' + $('#txtStreet').val();
        ...
        _assistData = {
            thisNewIncidentAssist: {
                ...
                BeatNumber: $('#ddlBeatNumbers').val(), //PostClientAssist2
