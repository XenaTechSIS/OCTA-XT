...
lata.FspWeb.prototype.dispatchViewModel = function () {
    ...
    self.fspFreeways = ko.observableArray([]);

    self.fspLocation = ko.observable();
    self.fspLocations = ko.observableArray([]);
    ...
    self.doDispatch = function () {
        ...
        console.log('Fsp Direction %s', self.fspDirection());
        console.log('Fsp Freeway %s', self.fspFreeway());
        console.log('Fsp Location %s', self.fspLocation());
