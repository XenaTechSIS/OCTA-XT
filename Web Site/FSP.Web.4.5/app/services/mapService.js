(function () {
  ...
  function mapService($http) {
    return {
      ...
      getFive11Polygons: function () {
        return $http({
          method: 'GET',
          url: $(".websiteUrl").text().trim() + '/Map/Get511Polygons'
        }).
          then(function (response) {
            return response.data;
          });
      ...
      saveFive11: function (five11) {
        console.log(five11);
        return $http({
          method: 'POST',
          data: five11,
          url: $(".websiteUrl").text().trim() + '/Map/Save511Polygon'
        }).
          then(function (response) {
            return response.data;
          });
      ...
      deleteFive11: function (five11SignId) {
        return $http({
          method: 'POST',
          data: {
            id: five11SignId
          },
          url: $(".websiteUrl").text().trim() + '/Map/Delete511'
        }).
          then(function (response) {
            return response.data;
          });
