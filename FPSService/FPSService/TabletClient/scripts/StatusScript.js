$(document).ready(function () {
    ...
    */
    ...
    $('#btnPatrol').click(function () {
        ...
        var currentStatus = localStorage.getItem("truckstate");
        if (currentStatus == "Driver Logged On") {
            $.fallr('show', {
                content: '<p>You cannot go On Patrol before Rolling Out\nPlease select Roll Out</p>',
                position: 'center',
                icon: 'lamp'
            });
            return;
