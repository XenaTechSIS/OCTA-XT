...
namespace FPSService
{
    ...
    public interface ITowTruckService
    {
        ...
        [OperationContract]
        void ExcuseAlarm(string _vehicleNumber, string _beatNumber, string _alarm, string _driverName, string _comments = "NO COMMENT");
    ...
    public class AssistScreenData
    {
        ...
        [DataMember]
        public bool AssistAcked { get; set; }
        [DataMember]
