...
<body>
    ...
    <div>
        ...
        <br />
        <asp:Button ID="btnReloadBeats" runat="server" onclick="btnReloadBeats_Click" 
    ...
    <div id="beatDiv">
        ...
        <br />
        <asp:GridView ID="gvBeats" runat="server" CellPadding="4" ForeColor="#333333" 
            GridLines="None">
    ...
    <div id="beatSegmentDiv">
        <label>Beat Segment Data</label>
        <hr />
        <asp:GridView ID="gvBeatSegments" runat="server" CellPadding="4" 
